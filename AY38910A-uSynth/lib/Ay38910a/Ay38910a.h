...
#define CHB_TONE_ENABLE  (1 << CHB_TONE)
#define CHB_TONE_DISABLE (0 << CHB_TONE)
...
#define CHB_NOISE_ENABLE  (1 << CHB_NOISE)
#define CHB_NOISE_DISABLE (0 << CHB_NOISE)

#define CHC_NOISE_ENABLE  (1 << CHC_NOISE)
#define CHC_NOISE_DISABLE (0 << CHC_NOISE)
